                    ...
                    <div class="card-body">
                        <div class="col-lg-12">
                            ...
                            <div class="form-group"><label>Nama Lengkap</label>
                                <input class="form-control" id="nama" name="nmlengkap" type="text" placeholder="">
                            </div>
            ...
            <div class="col-lg-4 mb-4">
                ...
                <div class="card border-bottom-primary shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <center>
                            <div id="img">
                                <img src="<?= base_url() ?>assets/icon/man.png" id="outputImg" width="200" maxheight="300">
                            </div>
                            <div id="pdf">
                                <embed src="<?= base_url() ?>assets/icon/man.png" id="outputPdf" width="300" height="400" type="application/pdf">
                            </div>
                        </center>
                        <br>
                        <!-- foto -->
