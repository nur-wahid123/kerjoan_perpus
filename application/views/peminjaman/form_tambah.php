                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="tglkembali" readonly class="form-control" value="<?= $tglplus5 ?>">
                                </div>
                            </div>
                    ...
                    <div class="card border-bottom-primary shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-3">
                                    <center>
                                        <img style="border-radius: 5px;" src="<?= base_url() ?>assets/upload/anggota/man.png" id="preview" width="75" maxheight="300">
                                    </center>
                                </div>
                                <div class="col-lg">
                                    <p id="namaL">-</p>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group mb-4">
                                    <select name="buku" class="form-control chosen" id="buku">
                            ...
                            <div class="col-lg-1">
                                <span class="badge badge-primary">Stok: <span id="stok"></span></span>
                            </div>

                            <div class="col-lg-1">
                                <div class="form-group">
                                    <input type="number" name="jml" id="numpinjam" class="form-control" value="0" max="1" min="0">
                                </div>
                            </div>
...
<script type="text/javascript">
    $('#buku').change(function() {
        var base_url = '<?= base_url(); ?>' + 'buku/getTotalStok';
        var buku = $(this).val();
        if (buku == '') {
