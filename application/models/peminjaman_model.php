...
class peminjaman_model extends ci_model{
    ...
    public function dataJoinbyId($idang)
    {
      $this->db->select('*');
      $this->db->from('peminjaman as p');
      $this->db->join('anggota as a', 'a.id_anggota = p.id_anggota');
      $this->db->where('p.id_anggota', $idang);
  ...
  public function peringatan()
    {
        ...
        $this->db->from('peminjaman as p');
        $this->db->join('anggota as a', 'a.id_anggota = p.id_anggota');
        $this->db->join('pengguna as peng', 'peng.id_anggota = p.id_anggota');
        $this->db->where('p.tempo = CURDATE()');
       return $this->db->get();
